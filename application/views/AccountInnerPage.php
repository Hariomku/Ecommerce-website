...
<body>
  ...
  <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zm3.915 10L3.102 4h10.796l-1.313 7h-8.17zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
              ...
              <a href="<?= base_url() ?>hariom"><li>My Cart</li></a>
              <!-- <a href="#"><li>Help</li></a> -->
...
<tr><td>
    <div class="login-form">    
        ...
        <tr><td class="heading">User Name</td>
        </tr>
        <tr><td class="value"><?= $value['Name']?></td>
        </tr>
        <tr><td class="heading">Date of Birth</td>
        </tr>
        <tr><td class="value"><?= $value['Date_of_Birth']?></td>
        </tr>
        <tr><td class="heading">Gender</td>
        </tr>
        <tr><td class="value"><?= $value['Gender']?></td>
        </tr>
        <tr><td class="heading">State</td>
        </tr>
        <tr><td class="value"><?= $value['State']?></td>
        </tr>
    </tr>
    <tr><td class="heading">Address</td>
    </tr>
</tr>
<tr><td class="value"><?= $value['Address']?></td>
</tr>
</tr>
<tr><td class="heading">Email Id</td>
</tr>
</tr>
<tr><td class="value"><?= $value['Email']?></td>
</tr>
</tr>
<tr><td class="heading">Phone Number</td>
</tr>
</tr>
<tr><td class="value"><?= $value['Phone_Number']?></td>
</tr>


<tr><td><a href="<?=base_url()?>whocart/logOut"><input  style="margin-top:2rem;" type="button" class="btn btn-primary btn-block " value="LogOut"></a>  </td></tr>
...
<script >
    $(function(){
         $('.btn').click(function(){
                swal("successfully LogOut!", "Now you Login Another Account!", "success");
...
<!-- close account code -->
            ...
            <div class="col-md-6">
                <div class="col" style="border-width: 1px;border-style: solid;padding: 0px; width:100%;height: 100%;"><iframe allowfullscreen="" frameborder="0" loading="lazy" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyALBOgobUw5vohwUm2sfOi6aKdfsCzyaiw&amp;q=creato software%2C+Jaipur%2C+Rajasthan&amp;zoom=11" width="100%" height="100%"></iframe></div>
            </div>
        </div>
    </div>
